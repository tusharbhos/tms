...
import { CreateApiWebhookLogsSchema, CreateApiWebhookLogsDto } from './dto/create-api-webhook-logs.dto';
import { UpdateApiWebhookLogsSchema, UpdateApiWebhookLogsDto } from './dto/update-api-webhook-logs.dto';
import { FilterApiWebhookLogsSchema, FilterApiWebhookLogsDto } from './dto/filter-api-webhook-logs.dto';
...
@ApiTags('integrations/webhook-logs')
@ApiBearerAuth()
@Controller('integrations/webhook-logs')
export class ApiWebhookLogsController {
  constructor(private readonly service: ApiWebhookLogsService,
  ...
  create(
    ...
    @Body(new ZodValidationPipe(CreateApiWebhookLogsSchema)) dto: CreateApiWebhookLogsDto,
  ) {
  ...
  findAll(
    @CurrentTenant() tenantId: number,
    @Query(new ZodValidationPipe(FilterApiWebhookLogsSchema)) query: FilterApiWebhookLogsDto,
  ) {
